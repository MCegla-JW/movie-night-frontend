...
const AccountPage = () => {
    ...
    return (
        <>
            <div className="w-full px-4 bg-gray-900 min-h-screen flex items-center justify-center flex-col pb-40 pt-20">
            <VscAccount size={70}/>
            <h4 className="mb-6 mt-4 text-center text-xl font-bold text-gray-400 pt-2">Your Username: {user.username}</h4>
