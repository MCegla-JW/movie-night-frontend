    ...
    <>
      <div className="w-full px-4 sm:px-0 bg-gray-900 pt-20">
        <div className="flex min-h-screen flex-col justify-center py-8 sm:py-12">
          <h1 className="mb-2 text-center text-xl font-bold sm:text-2xl text-gray-400">
            Create Watch Party
          </h1>
          <form onSubmit={handleSubmit}>
            <div className="form-control">
              <label
                htmlFor="title"
                className="block text-sm/6 font-semibold text-purple-400"
              >
                Party Title
              </label>
              <input
                className="block w-full border border-slate-600 rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
                type="title"
                name="title"
                id="title"
              ...
              />
              {errorData?.title && (
                <p className="error-message text-red-400 font-bold">
                  {errorData.title}
                </p>
              )}
            </div>
